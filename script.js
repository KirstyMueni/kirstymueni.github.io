...
const galleryData = {
  ...
  'edtech-stem': {
    ...
    images: [
      ...
      { name: 'Student Grade Predictor', src: '', description: 'This is a machine learning project developed in Python that predicts a student's final academic performance based on key factors such as study hours, attendance, assignment scores, and previous exam results. The project uses the Scikit-learn library to train a Linear Regression model on historical student data, enabling it to generate accurate grade predictions for new inputs. It also incorporates data visualization with Matplotlib to illustrate learning trends and presents results through an intuitive graphical user interface (GUI) built with Tkinter, demonstrating practical skills in machine learning, data analysis, Python programming, and educational technology.' },
